...
function TC2(name2) {
    return name2.toLowerCase().split(" ").map(function (word) {
        return (word.charAt(0).toUpperCase() + word.slice(1));
    }).join(" ");
}
console.log(TC2(name2));
console.log("-----using replace---------------");
let name3 = "my namE is ji"; ///dont give useless spaces especialy in start
function TC3(name3) {
    return name3.toLowerCase().split(" ").map(function (word) {
