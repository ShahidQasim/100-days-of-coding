...
for(let t of guestlist){console.log(`hey ${t}we have bigger dinner table, Oohu!!!!!!!!!!!!!! now we are able to add three more friends`)}
...
for (let i = 0; i < gl.length; i++) {console.log(`hey ${gl[i]}, plz join our bigger dinner table`)}
